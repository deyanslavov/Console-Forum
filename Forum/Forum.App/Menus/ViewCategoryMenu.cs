namespace Forum.App.Menus
{
    ...
    public class ViewCategoryMenu : Menu, IIdHoldingMenu, IPaginatedMenu
	{
        ...
        public ViewCategoryMenu(IPostService postService, ILabelFactory labelFactory, ICommandFactory commandFactory)
        {
        ...
        private bool IsFirstPage => this.currentIndex == 0;

        private bool IsLastPage => this.currentIndex == this.LastPage;
